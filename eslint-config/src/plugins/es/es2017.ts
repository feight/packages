 ...
 *
 *
 * https://eslint-plugin-es.mysticatea.dev/rules/#es2017
 */
...
export default {
    rules: {
         ...
         *
         * https://eslint-plugin-es.mysticatea.dev/rules/no-atomics.html
         */
        "es/no-atomics": "off",
         ...
         *
         * https://eslint-plugin-es.mysticatea.dev/rules/no-shared-array-buffer.html
         */
